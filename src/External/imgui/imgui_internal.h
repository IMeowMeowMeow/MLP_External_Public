...
//#endif
    ...
    IMGUI_API bool          TabButton(const char* label, const ImVec2& size_arg, bool selected);
    IMGUI_API bool          TabButton2(const char* label, const ImVec2& size_arg, bool selected);
