...
namespace ImGui
{
    ...
    IMGUI_API bool          CustomButton(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          ToggleButton(const char* label, bool* v, const ImVec2& size = ImVec2(0, 0), bool align = false);   // button
    IMGUI_API bool          PopupButton(const char* label, const ImVec2& size = ImVec2(0, 0)); 
    IMGUI_API bool          InventoryButton(const char* label, const ImVec2& size_arg, const std::string item_name);
    IMGUI_API bool          TabButton(const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);   // button
    IMGUI_API bool          TabButton2(const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);   // button
    ...
    IMGUI_API bool          ImHotkey(const char* label, int* k, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API bool          CustomCheckbox(const char* label, bool* v, bool hotkey = true);
    ...
    IMGUI_API void          MultiCombo(const char* label, std::map<std::string, bool&> items_map);
    ...
    IMGUI_API bool          CustomSliderFloat(const char* label, float* v, float v_min, float v_max, const char* format = "%.2f");
    ...
    IMGUI_API bool          CustomSliderInt(const char* label, int* v, int v_min, int v_max, const char* format = "%d");
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          CustomSliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          CustomSliderDouble(const char* label, double* v, double v_min, double v_max, const char* format = "%.2lf");

    IMGUI_API bool          ImVec2Editor(const char* label, ImVec2* position, const ImVec2& size_arg = ImVec2(320, 120));
    IMGUI_API bool          BezierCubicCurve(const char* label, ImVec2* p1, ImVec2* p2, const ImVec2& size_arg = ImVec2(320, 120));
    ...
    IMGUI_API bool          CustomSelectable(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0)); // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
