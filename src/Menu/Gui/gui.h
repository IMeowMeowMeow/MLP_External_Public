...
public:
    ...
    inline void draw_text(const ImVec2& pos, ImU32 col, const char* text_begin, bool outline = false, float font_size = 14.0f, const char* end = 0) {
    ...
    inline void draw_line(const ImVec2& p1, const ImVec2& p2, ImU32 col, float thickness = 1.0f) {
